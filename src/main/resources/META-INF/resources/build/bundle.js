...
var app = (function () {
    ...
    /* src\main\svelte\components\InputInterface.svelte generated by Svelte v3.25.0 */
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("InputInterface", slots, []);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<InputInterface> was created with unknown prop '${key}'`);
    	});
    ...
    class InputInterface extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	route0 = new Route({
    			props: { path: "/", component: InputInterface },
    			$$inline: true
    		});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, InputInterface });
    	return [];
    }
