...
var app = (function () {
    ...
    /* src\main\svelte\components\GamepadInputInterface.svelte generated by Svelte v3.25.0 */
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("GamepadInputInterface", slots, []);
    	...
    	onMount(() => __awaiter(void 0, void 0, void 0, function* () {
    		GEM.setButtonEventListener(GAMEPAD_X, 0, time => {
    			return {
    				keyboard: [KEYBOARD_SPACE, -KEYBOARD_SPACE]
    			};
    		});

    		GEM.setButtonEventListener(GAMEPAD_SELECT, 0, time => {
    			return { mouse: [MOUSE_1, -MOUSE_1] };
    		});

    		GEM.setButtonEventListener(GAMEPAD_START, 0, time => {
    			return { mouse: [MOUSE_3, -MOUSE_3] };
    		});

    		let rightClickPressed = false;

    		GEM.setButtonEventListener(GAMEPAD_RIGHT_STICK, 200, time => {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<GamepadInputInterface> was created with unknown prop '${key}'`);
    	});
    ...
    class GamepadInputInterface extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\main\svelte\pages\ConsumerPage.svelte generated by Svelte v3.25.0 */

    const { console: console_1 } = globals;
    const file = "src\\main\\svelte\\pages\\ConsumerPage.svelte";

    function create_fragment$3(ctx) {
    	let gamepadinputinterface;
    	let t0;
    	let button0;
    	let t2;
    	let button1;
    	...
    	let mounted;
    	let dispose;
    	gamepadinputinterface = new GamepadInputInterface({ $$inline: true });

    	const block = {
    		c: function create() {
    			create_component(gamepadinputinterface.$$.fragment);
    			t0 = space();
    			button0 = element("button");
    			button0.textContent = "Consume";
    			t2 = space();
    		...
    		m: function mount(target, anchor) {
    			mount_component(gamepadinputinterface, target, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*consume*/ ctx[1], false, false, false),
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(gamepadinputinterface.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(gamepadinputinterface.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(gamepadinputinterface, detaching);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("ConsumerPage", slots, []);
    ...
    player.srcObject = stream;*/
      ...
      stream.addTrack(event.track, stream);
    		...
    		client.ontrack = e => {
    			console.log(e);
    			$$invalidate(0, player.srcObject = e.streams[0], player);
    		};
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<ConsumerPage> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => fetch("/stream/reset");
    	...
    	$$self.$inject_state = $$props => {
    		if ("rtcserver" in $$props) rtcserver = $$props.rtcserver;
    	...
    	return [player, consume, click_handler, video_binding];
    }

    class ConsumerPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src\main\svelte\pages\ProducerPage.svelte generated by Svelte v3.25.0 */

    const { console: console_1$1 } = globals;
    const file$1 = "src\\main\\svelte\\pages\\ProducerPage.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*produce*/ ctx[0], false, false, false),
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("ProducerPage", slots, []);
    	let rtcserver = new RtcServer();
    	let player;
      ...
      server.addTrack(track, stream);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<ProducerPage> was created with unknown prop '${key}'`);
    	});
    	...
    	return [produce, click_handler];
    }

    class ProducerPage extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
